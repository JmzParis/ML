...
@app.cell(hide_code=True)
def _(color_mode_dropdown, mo, noise_schedule_dropdown, timesteps_slider):
    checkpoint_file_prefix_text = mo.ui.text(f"chk_{color_mode_dropdown.value}_{timesteps_slider.value}t_{noise_schedule_dropdown.value}", label="Checkpoint file prefix", )
